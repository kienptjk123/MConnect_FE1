...
import CourseInfoPanel from "@/app/(public)/(guest)/course/_components/CourseInfoPanel/CourseInfoPanel";
import ModuleLessons from "@/app/(public)/(guest)/course/_components/ModuleLessons/ModuleLessons";
