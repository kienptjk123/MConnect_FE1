...
import StaffTable from "@/app/manage/admin/manage-staff/staff-table";
import { Button } from "@/components/ui/button";
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card";
import { Separator } from "@/components/ui/separator";
import { useStaffQuery } from "@/queries/useStaff";
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm opacity-90">
                Manage your staff members efficiently
              </p>
            </div>
          </div>

          <Button
            onClick={() => router.push("/manage/admin/manage-staff/create")}
          ...
          {isError && (
            <div className="py-16 text-center">
              <div className="inline-flex flex-col items-center gap-3 text-red-600">
                ...
                <span>Failed to load staff. Please try again.</span>
              </div>
            </div>
          )}
          {Array.isArray(data) && <StaffTable data={data} />}
        </CardContent>
      </Card>
    </div>
  );
